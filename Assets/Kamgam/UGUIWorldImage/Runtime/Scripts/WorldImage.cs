...
namespace Kamgam.UGUIWorldImage
{
    ...
    public partial class WorldImage : MaskableGraphic, ILayoutElement, ICanvasRaycastFilter
    {
        ...
        /// </summary>
        public virtual float minWidth { get; } = 0f;

        public float maxWidth { get; } = float.MaxValue;
        ...
        /// </summary>
        public virtual float flexibleWidth { get; } = -1f;

        /// <summary>
        /// See ILayoutElement.minHeight.
        /// </summary>
        public virtual float minHeight { get; } = 0f;

        public float maxHeight { get; } = float.MaxValue;
        ...
        /// </summary>
        public virtual float flexibleHeight { get; } = -1f;

        /// <summary>
        /// See ILayoutElement.layoutPriority.
        /// </summary>
        public virtual int layoutPriority { get; } = 0;
