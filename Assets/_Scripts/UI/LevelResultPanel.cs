...
///   - Win/loss are driven automatically by GameEventsManager.gameEvents.onLevelCompleted
///     and onLevelFailed — you shouldn't need to call Show() manually unless you're
///     bypassing that event system.
/// </summary>
public class LevelResultPanel : MonoBehaviour {
  ...
  private void Start() {
    // This is what actually determines win vs. loss and shows the right panel:
    // GameEventsManager fires one event or the other when the level ends, and
    // we translate that straight into the matching Show() call.
  ...
  private void OnLevelCompleted() {
    Show(LevelResult.Win);
    }

  private void OnLevelFailed() {
    Show(LevelResult.Loss);
    }
